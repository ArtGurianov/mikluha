...
Сайт туристического агентства «Миклуха Маклай» — каталог направлений/выездов, фотоотчёты, отзывы и информационный Booking Modal (QR + предоплата + телефон организатора, без сбора пользовательских данных). Полное ТЗ — `PRD.md`.
