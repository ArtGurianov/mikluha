...
export function ReportsSection({ content }: { content: ContentSnapshot }) {
  ...
  return (
    <section id="routes" className="mx-auto max-w-6xl px-4 py-16 sm:px-6">
      <div className="mb-8 space-y-2">
        <h2 className="font-heading text-2xl font-semibold text-foreground sm:text-3xl">Места в программе</h2>
        <p className="max-w-2xl text-muted-foreground">Алтай, Енисей и Столбы — основные точки наших маршрутов.</p>
      </div>
